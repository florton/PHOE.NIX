...
scanner('data/comments.nix', function (tokens) {
    ...
    i(tokens[18]).should.equal(i({ line_num: 5, line_pos: 11, type: 'int', lexeme: '20' }))
    i(tokens[19]).should.equal(i({ line_num: 5, line_pos: 13, type: 'dot', lexeme: '.' }))
    i(tokens[20]).should.equal(i({ line_num: 5, line_pos: 14, type: 'int', lexeme: '0' }))
    i(tokens[21]).should.equal(i({ line_num: 5,line_pos: 16,type: 'comment',lexeme: '// int z = 28' }))
    i(tokens[22]).should.equal(i({ line_num: 5, line_pos: 29, type: 'EOL', lexeme: '\n' }))
})


scanner('data/variables.nix', function (tokens) {
    tokens.length.should.equal(68)
    ...
    i(tokens[25]).should.equal(i({ line_num: 5, line_pos: 11, type: 'int', lexeme: '10' }))
    i(tokens[26]).should.equal(i({ line_num: 5, line_pos: 13, type: 'dot', lexeme: '.' }))
    i(tokens[27]).should.equal(i({ line_num: 5, line_pos: 14, type: 'int', lexeme: '432' }))
    i(tokens[28]).should.equal(i({ line_num: 5, line_pos: 18, type: 'EOL', lexeme: '\n' }))
    i(tokens[29]).should.equal(i({ line_num: 6, line_pos: 0, type: 'type', lexeme: 'string' }))
    i(tokens[30]).should.equal(i({ line_num: 6, line_pos: 7, type: 'id', lexeme: 's' }))
    i(tokens[31]).should.equal(i({ line_num: 6, line_pos: 9, type: 'assop', lexeme: '=' }))
    i(tokens[32]).should.equal(i({ line_num: 6, line_pos: 11, type: 'string', lexeme: '"Hello"' }))
    i(tokens[33]).should.equal(i({ line_num: 6, line_pos: 19, type: 'EOL', lexeme: '\n' }))
    i(tokens[34]).should.equal(i({ line_num: 7, line_pos: 0, type: 'type', lexeme: 'bool' }))
    i(tokens[35]).should.equal(i({ line_num: 7, line_pos: 5, type: 'id', lexeme: 't' }))
    i(tokens[36]).should.equal(i({ line_num: 7, line_pos: 7, type: 'assop', lexeme: '=' }))
    i(tokens[37]).should.equal(i({ line_num: 7, line_pos: 9, type: 'bool', lexeme: 'true' }))
    i(tokens[38]).should.equal(i({ line_num: 7, line_pos: 14, type: 'EOL', lexeme: '\n' }))
    i(tokens[39]).should.equal(i({ line_num: 8, line_pos: 0, type: 'type', lexeme: 'bool' }))
    i(tokens[40]).should.equal(i({ line_num: 8, line_pos: 5, type: 'id', lexeme: 'f' }))
    i(tokens[41]).should.equal(i({ line_num: 8, line_pos: 7, type: 'assop', lexeme: '=' }))
    i(tokens[42]).should.equal(i({ line_num: 8, line_pos: 9, type: 'bool', lexeme: 'false' }))
    i(tokens[43]).should.equal(i({ line_num: 8, line_pos: 16, type: 'EOL', lexeme: '\n' }))
    i(tokens[44]).should.equal(i({ line_num: 9, line_pos: 0, type: 'type', lexeme: 'string' }))
    i(tokens[45]).should.equal(i({ line_num: 9, line_pos: 7, type: 'id', lexeme: 'str' }))
    i(tokens[46]).should.equal(i({ line_num: 9, line_pos: 11, type: 'assop', lexeme: '=' }))
    i(tokens[47]).should.equal(i({ line_num: 9,line_pos: 13,type: 'string',lexeme: '"First part of the string"' }))
    i(tokens[48]).should.equal(i({ line_num: 9, line_pos: 40, type: 'addop', lexeme: '+' }))
    i(tokens[49]).should.equal(i({ line_num: 9,line_pos: 42,type: 'string',lexeme: '"second part of the string"' }))
    i(tokens[50]).should.equal(i({ line_num: 9, line_pos: 70, type: 'EOL', lexeme: '\n' }))
    i(tokens[51]).should.equal(i({ line_num: 10, line_pos: 0, type: 'type', lexeme: 'int' }))
    i(tokens[52]).should.equal(i({ line_num: 10, line_pos: 4, type: 'id', lexeme: 'thing' }))
    i(tokens[53]).should.equal(i({ line_num: 10, line_pos: 10, type: 'EOL', lexeme: '\n' }))
    i(tokens[54]).should.equal(i({ line_num: 11, line_pos: 0, type: 'id', lexeme: 'x' }))
    i(tokens[55]).should.equal(i({ line_num: 11, line_pos: 1, type: 'comma', lexeme: ',' }))
    i(tokens[56]).should.equal(i({ line_num: 11, line_pos: 2, type: 'id', lexeme: 'thing' }))
    i(tokens[57]).should.equal(i({ line_num: 11, line_pos: 8, type: 'assop', lexeme: '=' }))
    i(tokens[58]).should.equal(i({ line_num: 11, line_pos: 10, type: 'int', lexeme: '5' }))
    i(tokens[59]).should.equal(i({ line_num: 11, line_pos: 12, type: 'EOL', lexeme: '\n' }))
    i(tokens[60]).should.equal(i({ line_num: 12, line_pos: 0, type: 'id', lexeme: 'y' }))
    i(tokens[61]).should.equal(i({ line_num: 12, line_pos: 2, type: 'assop', lexeme: '=' }))
    i(tokens[62]).should.equal(i({ line_num: 12, line_pos: 4, type: 'int', lexeme: '20' }))
    i(tokens[63]).should.equal(i({ line_num: 12, line_pos: 7, type: 'EOL', lexeme: '\n' }))
    i(tokens[64]).should.equal(i({ line_num: 13, line_pos: 0, type: 'id', lexeme: 'p' }))
    i(tokens[65]).should.equal(i({ line_num: 13, line_pos: 2, type: 'assop', lexeme: '=' }))
    i(tokens[66]).should.equal(i({ line_num: 13, line_pos: 4, type: 'int', lexeme: '29' }))
    i(tokens[67]).should.equal(i({ line_num: 13, line_pos: 6, type: 'EOL', lexeme: '\n' }))
